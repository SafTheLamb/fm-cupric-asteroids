...
-------------------------------------------------------------------------------
--CUPRIC-asteroid-particles

particle_animations.get_cupric_asteroid_particle_small_pictures = function(options)
...
particle_animations.get_cupric_asteroid_particle_medium_pictures = function(options)
  local options = options or {}
  return {
    sheet = {
...
particle_animations.get_cupric_asteroid_particle_big_pictures = function(options)
  local options = options or {}
  return {
    sheet = {
...
particle_animations.get_cupric_asteroid_particle_top_small_pictures = function(options)
  local options = options or {}
  return {
    sheet = {
...
particle_animations.get_cupric_asteroid_particle_top_big_pictures = function(options)
  local options = options or {}
  return {
    sheet = {
