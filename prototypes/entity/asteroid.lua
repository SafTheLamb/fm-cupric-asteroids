...
local simulations = require("__cupric-asteroids__.prototypes.factoriopedia-simulations")
...
local function asteroid_variation(asteroid_type, suffix, scale, size)
  ...
  {
    color_texture = {
      filename = "__wood-universe-assets__/graphics/entity/asteroid/".. asteroid_type .."/"..asteroid_sizes[size].."/".."asteroid-" .. asteroid_type .. "-" .. asteroid_sizes[size] .. "-colour-" .. suffix .. ".png",
    ...
    normal_map = {
      filename = "__space-age__/graphics/entity/asteroid/metallic/"..asteroid_sizes[size].."/".."asteroid-metallic-" .. asteroid_sizes[size] .. "-normal-" .. suffix .. ".png",
      premul_alpha = false,
      size = sizes_resolution[size][1],
      scale = scale
    },
    ...
    roughness_map = {
      filename = "__space-age__/graphics/entity/asteroid/metallic/"..asteroid_sizes[size].."/".."asteroid-metallic-" .. asteroid_sizes[size] .. "-roughness-" .. suffix .. ".png",
      premul_alpha = false,
      size = sizes_resolution[size][1],
      scale = scale
    }
    ...
    data:extend({
      {
        ...
        icon = "__wood-universe-assets__/graphics/icons/"..asteroid_name..".png",
        icon_size = 64,
...
data.raw["asteroid-chunk"]["cupric-asteroid-chunk"].graphics_set.lights[2] = { color = {0.85,0.5,0.4}, direction = {-1,-45,0.1} }
